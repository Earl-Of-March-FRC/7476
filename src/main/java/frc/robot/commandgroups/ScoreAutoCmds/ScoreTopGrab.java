package frc.robot.commandgroups.ScoreAutoCmds;
...
public class ScoreTopGrab extends SequentialCommandGroup {
  public ScoreTopGrab(Arm armMotors, Claw claw, DrivetrainSubsystem drivetrainSubsystem, VisionSubsystem vision) {
    addCommands(
